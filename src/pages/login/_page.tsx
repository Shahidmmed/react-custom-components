...
import {
  ...
  FormWizard,
  WizardStage,
} from "../../components/layout/form_wizard/_component";
          ...
          <div className="xl:w-10/12">
            <div className="block bg-white shadow-lg rounded-lg">
              <div className="lg:flex lg:flex-wrap g-0">
                ...
                <div className="lg:w-6/12 bg-mtn flex items-center lg:rounded-r-lg rounded-b-lg lg:rounded-bl-none">
